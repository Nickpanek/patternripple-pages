...
export default defineType({
  ...
  fields: [
    ...
    },
    {
      ...
      title: 'Subcategory',
      type: 'string',
      description: 'e.g., roses, skulls, Christmas, etc.',
    },
    {
      name: 'tags',
      title: 'Tags',
    ...
    // Images and Files
    {
      ...
      type: 'image',
      description: 'Watermarked preview for catalog',
      validation: (Rule) => Rule.required(),
    },
    {
      name: 'sourceFile',
      title: 'Source File (6000x6000)',
      type: 'file',
      description: 'High-resolution PNG for buyers',
    },
    {
      name: 'mockups',
    ...
    // Offer System
    {
      ...
      type: 'boolean',
      description: 'Enable after 30 days listed',
      initialValue: false,
    },
    {
      name: 'minimumOffer',
    ...
    // Display Options
    {
      ...
      type: 'boolean',
      description: 'Show on homepage/category highlights',
      initialValue: false,
    },
    {
      name: 'priority',
  ...
  preview: {
    ...
    prepare(selection) {
      ...
      return {
        title: title,
        subtitle: `${statusEmoji} ${category} - $${price}`,
        media: media,
      }
    },
  },
