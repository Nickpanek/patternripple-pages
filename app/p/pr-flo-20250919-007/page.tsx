...
export default function ProductPage() {
  const product = {
    ...
    subtitle: "Impasto Floral Collection",
    sku: "PR-flo-20250919-007",
    stripePriceId: "price_1S9FzSBB8R6OUfKVq5fzIpQw",  // REPLACE WITH YOUR STRIPE PRICE ID
    images: [
      "https://files.patternripple.com/PR-flo-20250919-007-preview.jpg",
      "https://files.patternripple.com/PR-flo-20250919-007-mockup1.jpg",
      "https://files.patternripple.com/PR-flo-20250919-007-mockup2.jpg",
      "https://files.patternripple.com/PR-flo-20250919-007-mockup3.jpg",
      "https://files.patternripple.com/PR-flo-20250919-007-mockup4.jpg",
      "https://files.patternripple.com/PR-flo-20250919-007-mockup5.jpg",
      "https://files.patternripple.com/PR-flo-20250919-007-mockup6.jpg",
      "https://files.patternripple.com/PR-flo-20250919-007-mockup7.jpg",
      "https://files.patternripple.com/PR-flo-20250919-007-mockup8.jpg",
      "https://files.patternripple.com/PR-flo-20250919-007-mockup9.jpg",
      "https://files.patternripple.com/PR-flo-20250919-007-mockup10.jpg",
      "https://files.patternripple.com/PR-flo-20250919-007-mockup11.jpg",
    ],
    description:
    ...
    <main className="max-w-7xl mx-auto px-4 py-12">
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-4">
          ...
          {/* Thumbnail Gallery - 12 images total (preview + 11 mockups) */}
          ...
          {/* Remaining images (9th-12th) on their own row */}
          <div className="grid grid-cols-4 gap-2">
