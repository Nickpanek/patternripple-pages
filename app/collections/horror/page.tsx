// app/collections/horror/page.tsx
"use client";
...
export default function HorrorCollectionPage() {
  ...
  const horrorProducts = useMemo(() => filterByCollection(products, "horror"), []);
  const availableCount = useMemo(() => countAvailable(products, "horror"), []);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-red-950">
      ...
      <div className="bg-gradient-to-r from-red-700 to-gray-900 text-white py-3">
        <div className="max-w-6xl mx-auto px-4 text-center text-sm">
          {horrorProducts.length === 0
            ? "No Horror Patterns Available"
            : `${availableCount} Exclusive Horror Patterns Available`}
        </div>
      </div>
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        {horrorProducts.length === 0 ? (
          <div className="text-center text-gray-400 py-24">
            <p>No horror patterns available right now.</p>
          </div>
        ) : (
